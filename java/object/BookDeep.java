...
public class BookDeep implements Cloneable {
    ...
    public BookDeep(String title, String date, int pageCount, Author author) {
        this.title = title;
        this.date = date;
    ...
    public BookDeep clone() {
        Author au = new Author(author.getName(), author.getRealName(), author.getBirthYear(), author.getDeathYear());
        BookDeep bd = new BookDeep(title, date, pageCount, au);
        return bd;
    }
