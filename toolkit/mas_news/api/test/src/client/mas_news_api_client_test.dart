...
void main() {
  ...
  group('MasNewsApiClient', () {
    late http.Client httpClient;
    late MasNewsApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = MasNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => MasNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = MasNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws MasNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<MasNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws MasNewsApiRequestFailure '
